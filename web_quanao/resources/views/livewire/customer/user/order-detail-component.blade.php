            		...
            		<div id="payment-address-content">
                		<div class="row">
	                    	...
	                    	<div class="col-md-6 col-sm-6">
	                    		...
	                    		<div class="form-group">
	                        		<label for="firstname">Tên địa chỉ</label>
	                        		<input type="text" id="firstname" class="form-control" value="{{$dia_chi->ten_dia_chi}}" readonly>
	                    		</div>	                    		
	                    		<div class="form-group">
	                        		<label for="firstname">Địa chỉ</label>
	                        		<input type="text" id="firstname" class="form-control" value="{{$dia_chi->dia_chi_cu_the}}" readonly>
	                    		</div>	
	                    		<div class="form-group">
	                        		<label for="firstname">Phường/xã</label>
	                        		<input type="text" id="firstname" class="form-control" value="{{$dia_chi->ten_phuong_xa}}" readonly>
	                    		</div>
	                    		<div class="form-group">
	                        		<label for="firstname">Quận/huyện</label>
	                        		<input type="text" id="firstname" class="form-control" value="{{$dia_chi->ten_quan_huyen}}" readonly>
	                    		</div>
	                    		<div class="form-group">
	                        		<label for="firstname">Tỉnh/thành phố</label>
	                        		<input type="text" id="firstname" class="form-control" value="{{$dia_chi->tinh_thanh_pho}}" readonly>
	                    		</div>	                    				
	                    	</div>
                    		<hr>
            			</div>                    	
                			...
                			<div class="shopping-total">
			                	<ul>
			                    	<li>
			                      		...
			                      		<strong class="price">{{number_format($hoa_don->tong_tien_hang)}} VND</strong>
			                    	</li>
				                    <li>
				                    ...
				                    <li class="shopping-total-price">
				                    	...
				                    	<strong class="price">{{number_format($hoa_don->tong_tien)}} VND</strong>
				                    </li>
			                  	</ul>
                			</div>
            			</div>
            			<button class="btn btn-default" type="submit">Về trang chủ <i class="fa fa-shopping-cart"></i></button>
            			@if($hoa_don->tinh_trang == '1')
            			<a href="{{route('cancel-order', $hoa_don->ma_don_hang)}}" class="btn btn-primary">Hủy đơn hàng <i class="far fa-times"></i></a>
            			@endif
            		</div>
          		</div>
        	</form>
