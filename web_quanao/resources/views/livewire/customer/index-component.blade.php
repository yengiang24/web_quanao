              ...
              <div>
                <div class="product-item">
                  <div class="pi-img-wrapper">
                    <img src="images/products/{{$spham->anh_sp}}" class="img-responsive" alt="Berry Lace Dress">
                    <div>
                      <a href="images/products/{{$spham->anh_sp}}" class="btn btn-default fancybox-button"><i class="fas fa-eye"></i></a>
                      <a href="#product-pop-up" class="btn btn-default fancybox-fast-view">Xem nhanh</a>
                    </div>
                  </div>
                  <h3><a href="{{route('product', $spham->ma_so_sp)}}">{{$spham->ten_sp}}</a></h3>
                  <div class="pi-price">{{number_format($spham->gia_ban)}} VND</div>
        ...
        <div class="row margin-bottom-40 ">
          ...
          <div class="sidebar col-md-3 col-sm-4">
            <ul class="list-group margin-bottom-25 sidebar-menu">
              ...
              <li class="list-group-item clearfix"><a href="{{route('product-list', $dmuc->ma_so)}}"><i class="fa fa-angle-right"></i> {{$dmuc->ten}}</a></li>
              @endforeach
          ...
          <div class="col-md-9 col-sm-8">
            ...
            <div class="owl-carousel owl-carousel3">
              @foreach($noi_bat as $nbat)
              <div>
                <div class="product-item">
                  <div class="pi-img-wrapper">
                    <img src="images/products/{{$spham->anh_sp}}" class="img-responsive" alt="Berry Lace Dress">
                    <div>
                      <a href="images/products/{{$spham->anh_sp}}" class="btn btn-default fancybox-button"><i class="fas fa-search"></i></a>
                      <a href="#product-pop-up" class="btn btn-default fancybox-fast-view">Xem nhanh</a>
                    </div>
                  </div>
                  <h3><a href="shop-item.html">{{$nbat->ten_sp}}</a></h3>
                  <div class="pi-price">{{number_format($spham->gia_ban)}} VND</div>
    ...
    <div class="brands">
      <div class="container">
            <div class="owl-carousel owl-carousel6-brands">
              <a href="shop-product-list.html"><img src="customer/assets/pages/img/brands/canon.jpg" alt="canon" title="canon"></a>
        ...
        <div class="row">
          <div class="col-md-4 steps-block-col">
            ...
            <div>
              ...
              <em>Giao hàng trong vòng 3 ngày</em>
            </div>
            <span>&nbsp;</span>
          </div>
          <div class="col-md-4 steps-block-col">
            ...
            <div>
              <h3>Mã giảm giá</h3>
              <em>Hàng nghìn mã giảm giá khác nhau</em>
            </div>
            <span>&nbsp;</span>
          </div>
          <div class="col-md-4 steps-block-col">
            ...
            <div>
              <h3>02923 111 111</h3>
              <em>24/7 dịch vụ chăm sóc khách hàng</em>
            </div>
          </div>
        </div>
      </div>
